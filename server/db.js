...
db.serialize(()=>{
    ...
    db.run('CREATE TABLE post_groups (postID INTEGER, groupID INTEGER, FOREIGN KEY(postID) REFERENCES posts(id), FOREIGN KEY(groupID) REFERENCES groups(id))')
    db.run('CREATE TABLE group_friends (friendID INTEGER, groupID INTEGER, FOREIGN KEY(friendID) REFERENCES friends(id), FOREIGN KEY(groupID) REFERENCES groups(id))')

    
    db.run('INSERT INTO groups (groupName) VALUES ("Family"), ("Friends"), ("Dudes")')
    ...
    db.run('INSERT INTO post_groups (postID, groupID) VALUES (1,1)')
    db.run('INSERT INTO group_friends (friendID, groupID) VALUES (2,1)')
